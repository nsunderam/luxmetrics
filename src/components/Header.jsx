...
export default function Header({ currency, onCurrencyChange }) {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-graphite bg-white/90 backdrop-blur-xl">
      <div className="max-w-[1600px] mx-auto px-6 h-16 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[10px] text-muted tracking-[0.2em] uppercase -mt-0.5">Price Intelligence</p>
          </div>
        </div>

        <div className="flex items-center gap-4">
          <div className="hidden sm:flex items-center gap-2 px-3 py-1.5 rounded-full bg-carbon border border-graphite text-xs text-muted">
          ...
          <div ref={ref} className="relative">
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 rounded-lg bg-carbon border border-graphite hover:border-steel transition-colors cursor-pointer"
            >
